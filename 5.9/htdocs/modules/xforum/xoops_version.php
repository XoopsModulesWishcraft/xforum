...
$modversion['releasedate'] = "Wednesday: January 19, 2011";
...
$modversion['release_info'] = "Stable 2012/01/19";
$modversion['release_file'] = XOOPS_URL."/modules/xforum/docs/changelog.txt";
$modversion['release_date'] = "2012/01/19";
...
$modversion['status_version'] = "5.90";

$modversion['warning'] = "For XOOPS 2.6 or later";
...
if (isset($_POST["op"]))
	if( "update_ok" == $_POST["op"] ) {
		$GLOBALS['forum_handler'] = $GLOBALS['xoops']->getModuleHandler('forum', 'xforum', true);
