...
if ( !empty($_POST['option_id']) ) {
	...
	$GLOBALS['xoops']->redirect("viewtopic.php?topic_id=$topic_id&amp;forum=$xforum&amp;poll_id=$poll_id&amp;pollresult=1", 1, $msg);
	exit();
}
$GLOBALS['xoops']->redirect("viewtopic.php?topic_id=$topic_id&amp;forum=$xforum", 1, "You must choose an option !!");
