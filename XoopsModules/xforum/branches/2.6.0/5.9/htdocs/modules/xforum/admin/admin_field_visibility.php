...
if ( $op == "del" ) {
	...
	$GLOBALS['xoops']->redirect("field_visibility.php", 2, sprintf(_AM_XFORUM_DELETEDSUCCESS, _AM_XFORUM_PROF_VISIBLE) );
	exit();
}
...
$GLOBALS['xoops']->tpl->assign('fields', $fields);
$GLOBALS['xoops']->tpl->assign('visibilities', $visibilities);
$GLOBALS['xoops']->tpl->assign('groups', $groups);
...
$add_form->assign($GLOBALS['xoops']->tpl);

$GLOBALS['xoops']->tpl->display("admin:xforum|xforum_admin_visibility.html");
