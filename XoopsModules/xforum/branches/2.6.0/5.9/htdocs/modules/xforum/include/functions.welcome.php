...
function forum_welcome_create( &$user, $forum_id )
{
	...
	$profile_handler = $GLOBALS['xoops']->getHandler('profile');
	$fields = $profile_handler->loadFields();
	$cat_handler = $GLOBALS['xoops']->getModuleHandler('category', 'profile');
	$categories = $cat_handler->getObjects(null, true, false);
	$fieldcat_handler = $GLOBALS['xoops']->getModuleHandler('fieldcategory', 'profile');
