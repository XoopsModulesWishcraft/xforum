<?php
// $Id: delete.php,v 4.03 2008/06/05 15:35:59 wishcraft Exp $
//  ------------------------------------------------------------------------ //
...
if ( $ok ) {
    $isDeleteOne = (xforum_DELETEONE == $ok)? true : false;
    /*
	...
	*/    
	...
	xoops_confirm(array('post_id' => $post_id, 'viewmode' => $viewmode, 'order' => $order, 'forum' => $forum, 'topic_id' => $topic_id, 'ok' => xforum_DELETEONE), 'delete.php', _MD_DEL_ONE);
	if($isadmin){
    	xoops_confirm(array('post_id' => $post_id, 'viewmode' => $viewmode, 'order' => $order, 'forum' => $forum, 'topic_id' => $topic_id, 'ok' => xforum_DELETEALL), 'delete.php', _MD_DEL_RELATED);
	}
