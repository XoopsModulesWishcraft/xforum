<?php
// $Id: dl_attachment.php,v 4.03 2008/06/05 15:35:59 wishcraft Exp $
//  ------------------------------------------------------------------------ //
...
$viewtopic_forum =& $xforum_handler->get($xforumtopic->getVar('forum_id'));
if (!$xforum_handler->getPermission($viewtopic_forum))    die(_MD_NORIGHTTOACCESS);
