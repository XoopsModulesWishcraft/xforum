...
{
	return xforum_setModuleConfig($module, true);
}
...
function xoops_module_pre_install_xforum(&$module)
{
	...
	return xforum_setModuleConfig($module);
}
...
function xoops_module_install_xforum(&$module)
{
    ...
    $xforum_id = $xforum_handler->insert($xforum);
    ...
    foreach ($groups_view as $group_id) {
        ...
        $gperm_handler->addRight("forum_access", $xforum_id, $group_id, $module_id);
        $gperm_handler->addRight("forum_view", $xforum_id, $group_id, $module_id);
    }
    foreach ($groups_post as $group_id) {
	    foreach($post_items as $item){
        	$gperm_handler->addRight("forum_".$item, $xforum_id, $group_id, $module_id);
    	}
    }
...
function xforum_setModuleConfig(&$module, $isUpdate = false) 
{
	return true;
}
?>