<?php
// $Id: notification.inc.php,v 4.03 2008/06/05 15:35:33 wishcraft Exp $
//  ------------------------------------------------------------------------ //
...
if ( !defined('xforum_NOTIFY_ITEMINFO') ) {
define('xforum_NOTIFY_ITEMINFO', 1);

function xforum_notify_iteminfo($category, $item_id)
{
