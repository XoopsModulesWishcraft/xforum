...
if(defined("xforum_FUNCTIONS_INI")) return; define("xforum_FUNCTIONS_INI",1);

include_once(XOOPS_ROOT_PATH."/Frameworks/art/functions.php");

function xforum_load_object()
{
	return load_object();
}

function xforum_message( $message )
{
...
// Backword compatible
function xforum_load_lang_file( $filename, $module = '', $default = 'english' )
{
...
function xforum_getIP($asString = false)
{
	return mod_getIP($asString);
}

function xforum_formatTimestamp($time, $format = "c", $timeoffset = "")
{
    ...
    case 'custom':
    default:
    	xforum_load_lang_file("main", "xforum");
