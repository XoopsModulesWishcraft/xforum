...
class XforumField extends XoopsObject
{
    ...
    function getEditElement($user, $profile)
    {
        ...
        switch ($this->getVar('field_type')  ) {
            ...
            case "editor":
				...
				$editor_config['editor'] = $GLOBALS['xoopsModuleConfig']['editor'];
				$editor_config['value'] = $value;
				$editor_config['width'] = $GLOBALS['xoopsModuleConfig']['editor_width'];
				$editor_config['height'] = $GLOBALS['xoopsModuleConfig']['editor_height'];
        ...
        switch ($this->getVar('field_type')  ) {
            ...
            case "datetime":
                if (!empty($value)) {
                       ...
                       return $value = _OBJS_MI_NEVER_LOGGED_IN;
                   }
                break;
    ...
    */
    ...
    {
        $objects_handler = xoops_getmodulehandler('extras', 'objects');
