...
if ($GLOBALS['xoopsModuleConfig']['htaccess']) {
	$url = XOOPS_URL.'/'.$GLOBALS['xoopsModuleConfig']['baseurl'].'/search'.$GLOBALS['xoopsModuleConfig']['endofurl'].'?'.http_build_query(array_merge($_POST, $_GET));
...
$xoopsConfig['module_cache'][$GLOBALS['xforumModule']->getVar('mid')] = 0;
...
$xoopsTpl->assign("forumindex", sprintf(_MD_XFORUMINDEX, htmlspecialchars($xoopsConfig['sitename'], ENT_QUOTES)));
