...
if(isset($_REQUEST['menumode'])){
	...
	forum_setcookie("M", $menumode, $xforumCookie['expire']);
}else{
...
$forum_module_header .= '
	...
	<script src="'.XOOPS_URL.'/modules/'.$xoopsModule->getVar('dirname').'/include/js/forum_toggle.js" type="text/javascript"></script>
	';
if($menumode==2){
	$forum_module_header .= '
...
$xTheme->addJS(XOOPS_URL."/modules/".$xoopsModule->getVar("dirname")."/include/js/forum_toggle.js");
