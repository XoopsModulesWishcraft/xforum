...
class xforum_XoopsGroupPermForm extends XoopsGroupPermForm
{
    function xforum_XoopsGroupPermForm($title, $modid, $permname, $permdesc, $url = "")
    {
    ...
    { 
        ...
        foreach (array_keys($glist) as $i) {
            ...
            $ele = new xforum_XoopsGroupFormCheckBox($glist[$i], 'perms[' . $this->_permName . ']', $i, $selected);
...
class xforum_XoopsGroupFormCheckBox extends XoopsGroupFormCheckBox
{
    function xforum_XoopsGroupFormCheckBox($caption, $name, $groupId, $values = null)
    {
...
switch($action){
	...
	default:
		...
		$form = new xforum_XoopsGroupPermForm($fm_options[$op]["title"], $module_id, $fm_options[$op]["item"], $fm_options[$op]["desc"], 'admin/admin_permissions.php', $fm_options[$op]["anonymous"]);
