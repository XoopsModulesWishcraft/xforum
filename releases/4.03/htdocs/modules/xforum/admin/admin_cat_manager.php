...
switch ($op) {
    case "manage":
        ...
        foreach($categories as $key => $onecat) {
            $cat_edit_link = "<a href=\"admin_cat_manager.php?op=mod&cat_id=" . $onecat->getVar('cat_id') . "\">".xforum_displayImage($xforumImage['edit'], _EDIT)."</a>";
            $cat_del_link = "<a href=\"admin_cat_manager.php?op=del&cat_id=" . $onecat->getVar('cat_id') . "\">".xforum_displayImage($xforumImage['delete'], _DELETE)."</a>";
