...
switch ($op)
{
	...
	echo "
		...
		<div style='padding: 8px;'>\n
		<ul><li>".xforum_displayImage($xforumImage['delete'], _DELETE)." " . _AM_XFORUM_VOTE_DELETEDSC . "</li></ul>
		<div>\n
		</fieldset>\n
		<br />\n
        ...
        while (list($ratingid, $topic_id, $ratinguser, $rating, $ratinghostname, $ratingtimestamp) = $xoopsDB->fetchRow($results))
        {
            ...
            $ratinguname = xforum_getUnameFromId($ratinguser, $xoopsModuleConfig['show_realname']);
	echo "
		<tr>\n
		...
		<td class='even' align='center'><strong><a href='admin_votedata.php?op=delvotes&amp;topic_id=$topic_id&amp;rid=$ratingid'>".xforum_displayImage($xforumImage['delete'], _DELETE)."</a></strong></td>\n
		</tr>\n";
        }
        echo "</table>";
