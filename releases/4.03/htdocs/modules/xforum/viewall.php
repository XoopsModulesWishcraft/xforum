<?php
// $Id: viewall.php,v 4.03 2008/06/05 15:35:59 wishcraft Exp $
//  ------------------------------------------------------------------------ //
...
$viewall_forums = $xforum_handler->getForums(0,'access', array("forum_id", "cat_id", "forum_name")); // get all accessible forums
...
// assign to template
$xoopsTpl->assign('forum_selection_since', $xforum_selection_since);
...
list($allTopics, $sticky) = $xforum_handler->getAllTopics($viewall_forums, $startdate, $start, $sortname, $sortorder, $type);
...
$all_topics = $xforum_handler->getTopicCount($viewall_forums, $startdate, $type);
...
if(!empty($xoopsModuleConfig['show_jump'])){
	$xoopsTpl->assign('forum_jumpbox', xforum_make_jumpbox());
}
