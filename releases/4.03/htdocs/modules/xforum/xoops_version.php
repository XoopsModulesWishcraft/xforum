<?php
// $Id: xoops_version.php,v 4.03 2008/06/05 15:35:59 wishcraft Exp $
//  ------------------------------------------------------------------------ //
...
$modversion['version'] = 4.03;
$modversion['description'] = _MI_XFORUM_DESC;
$modversion['credits'] = "xforum 2 developed by Marko Schmuck (predator) and S.A.R. (wishcraft)";
$modversion['author'] = "S.A.R. (wishcraft)";
...
$modversion['author_realname'] = "X-Forum Dev Team";
$modversion['author_website_url'] = "http://www.chronolabs.org.au";
$modversion['author_website_name'] = "Chronolabs";
$modversion['author_email'] = "lsd25@hotmail.com";
$modversion['status_version'] = "4.03";
$modversion['status'] = "Trial";
...
//$modversion['templates'][14]['file'] = 'xforum_viewpost_list.html';
...
$modversion['search']['func'] = "xforum_search";
...
$xforum_options = array(_NONE => 0);
if( $isModuleAction && "update_ok" == $_POST["op"] ) {
	$xforum_handler =& xoops_getmodulehandler('forum', 'xforum', true);
	$xforums = $xforum_handler->getForumsByCategory(0, '', false, array("parent_forum", "cat_id", "forum_name"));
	if($xforums):
	foreach (array_keys($xforums) as $c) {
		foreach(array_keys($xforums[$c]) as $f){
			$xforum_options[$xforums[$c][$f]["title"]]=$f;
	        if(!isset($xforums[$c][$f]["sub"])) continue;
			foreach(array_keys($xforums[$c][$f]["sub"]) as $s){
				$xforum_options["-- ".$xforums[$c][$f]["sub"][$s]["title"]]=$s;
			}
		}
	}
	unset($xforums);
...
$modversion['config'][] = array(
	...
	'valuetype' => 'int',
	'default' => 0,
	'options' => $xforum_options);

// Notification
$modversion["notification"] = array();
$modversion['hasNotification'] = 1;
$modversion['notification']['lookup_file'] = 'include/notification.inc.php';
$modversion['notification']['lookup_func'] = 'xforum_notify_iteminfo';
