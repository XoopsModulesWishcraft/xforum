...
class xforumDigestHandler extends XoopsObjectHandler {
    ...
    function buildDigest(&$digest)
    {
        ...
        $xforum_criteria = ' AND t.forum_id IN (' . implode(',', array_keys($access_forums)) . ')';
        unset($access_forums);
        ...
        foreach($rows as $topic) {
            ...
            $summary = xoops_substr(xforum_html2text($topic['post_text']), 0, SUMMARY_LENGTH);
