<?php
// $Id: edit.php,v 4.03 2008/06/05 15:35:59 wishcraft Exp $
//  ------------------------------------------------------------------------ //
...
if ( empty($forum) ) {
    ...
    if (!$istopic) {
    	...
    	if($forumpost2->getVar('uid')) {
	    	$r_name = xforum_getUnameFromId( $forumpost2->getVar('uid'), $xoopsModuleConfig['show_realname']);
			if (xforum_isAdmin($forum_obj, $forumpost2->getVar('uid'))) $isadmin = 1;
    	}else{
