...
switch($op){
	...
	default:
		...
		foreach($reports as $report){
			$post_link = "<a href=\"".XOOPS_URL."/modules/".$GLOBALS['xforumModule']->getVar('dirname')."/viewtopic.php?post_id=". $report['post_id'] ."&amp;topic_id=". $report['topic_id'] ."&amp;forum=". $report['forum_id'] ."&amp;viewmode=thread\" target=\"checkreport\">".$myts->htmlSpecialChars($report['subject'])."</a>";
