...
class Category extends XoopsObject {
    ...
    function getURL()
    {
    	if ($GLOBALS['xoopsModuleConfig']['htaccess']) {
    		return urldecode($this->getVar('cat_domain')) . '/' . $GLOBALS['xoopsModuleConfig']['baseurl'] . '/cat,'.$this->getVar('cat_id') . $GLOBALS['xoopsModuleConfig']['endofurl'];
    	} else {
    		return urldecode($this->getVar('cat_domain')) . '/modules/xforum/index.php?cat='.$this->getVar('cat_id');
    	}
    }
}
