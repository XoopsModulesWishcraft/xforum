...
// ------------------------------------------------------------------------- //
	...
	include_once XOOPS_ROOT_PATH."/modules/".$xforumModule->getVar("dirname")."/include/vars.php";
	include_once XOOPS_ROOT_PATH."/modules/".$xforumModule->getVar("dirname")."/include/admin.functions.php";
