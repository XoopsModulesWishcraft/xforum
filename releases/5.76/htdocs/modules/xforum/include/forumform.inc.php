...
$all_categories = $forum_handler->getObjects($criteria, true, false);
...
foreach (array_keys($fields) as $i) {
	if (($post_id<>0&&$gperm_handler->checkRight('xforum_field_edit',$fields[$i]->getVar('field_id'),$groups, $modid)) ||
		($post_id==0&&$gperm_handler->checkRight('xforum_field_post',$fields[$i]->getVar('field_id'),$groups, $modid))) {
