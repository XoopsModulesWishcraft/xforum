            ...
            if ($totalpages > 1) {
                ...
                for ($i = 1; $i <= $totalpages; $i++) {
                    if ($i > 3 && $i < $totalpages) {
                        ...
                        $topic_page_jump .= '[<a href="' . $topic_obj->getURL_JUMPBOX((($i - 1) * $xoopsModuleConfig['posts_per_page']), $myrow['post_id']) . '">' . $i . '</a>]';
                        $topic_page_jump_icon = "<a href='" . $topic_obj->getURL_JUMPBOX((($i - 1) * $xoopsModuleConfig['posts_per_page']), $myrow['post_id']) . "'>" . forum_displayImage($xforumImage['docicon']) . "</a>";
                    }
                }
            }
            else {
