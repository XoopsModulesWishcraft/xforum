...
if ($forum_handler->getPermission($forum_obj, "post")){
	$xoopsTpl->assign('forum_newtopic_img', "<a href=\"newtopic.php?forum=".$forum_obj->getVar('forum_id')."\"><img src='".XOOPS_URL."/modules/xforum/images/imagesets/default/english/t_new-a.png'></a>");
