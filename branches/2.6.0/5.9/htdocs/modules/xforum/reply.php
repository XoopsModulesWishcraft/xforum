...
if ( !$topic_handler->getPermission($forum_obj, $GLOBALS['topic_status'], 'reply')){
	$GLOBALS['xoops']->redirect(XOOPS_URL."/modules/xforum/viewtopic.php?topic_id=$topic_id&amp;order=$order&amp;viewmode=$viewmode&amp;pid=$pid&amp;forum=".$forum_obj->getVar('forum_id'), 2, _MD_NORIGHTTOREPLY);
    exit();
}
