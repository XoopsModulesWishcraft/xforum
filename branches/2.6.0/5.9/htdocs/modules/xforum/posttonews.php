...
if(!$isOK)$GLOBALS['xoops']->redirect('index.php', 3, _MD_ERROR);
...
if ( isset($_GET['post_id']) ) {
	...
	$GLOBALS['xoops']->redirect('index.php', 3, _MD_ERRORPOST);
}
...
switch ($op)
{
	...
	$GLOBALS['xoops']->redirect(XOOPS_URL.'/modules/news/submit.php?op=edit&amp;storyid=' . $story->storyid(), 3, _MD_THANKSSUBMIT);
	break;
